...
\begin{itemize}
    \item to add PDF meta-data at the beginning of main.tex according to Figure \ref{fig:enter-label} with your own information.
...
\begin{figure}[!h]
    \centering
    \pdftooltip{\includegraphics[width=0.5\textwidth]{figs/meta_eng.jpg}}{Example to define PDF meta-data in latex-system.}
    \caption{Example to define PDF meta-data in latex-system.}
