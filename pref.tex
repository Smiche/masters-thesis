...
\usepackage[style=ext-authoryear,sorting=nyt,natbib=true,backend=biber,backref=false,dashed=false,giveninits=true,maxbibnames=99,articlein=false,uniquename=init]{biblatex} % settings for citations and references
