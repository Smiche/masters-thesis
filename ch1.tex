...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This document determines a LUT thesis's basic layout and formatting using \LaTeX. The purpose of these instructions is to set uniform formatting rules to be used at Lappeenranta-Lahti University of Technology LUT and to make the writing process more effective as the routine settings have already been determined. The student can concentrate better on the actual thesis work.

When writing a thesis, this document can be set as a starting document, in which the different sections are replaced by the author's text and the document saved to a different name. Besides determining the formatting, this document contains instructions on the contents of different sections in a thesis. More instructions for using \LaTeX~can be obtained from \href{https://ctan.org/}{\textcolor{blue}{CTAN}} database or textbooks. The CTAN database contains all manuals and instructions for all \LaTeX~packages. A good starting point for using \LaTeX~is to familiarize yourself with the \textit{A short introduction to \LaTeXe} document. Different language versions can be found from  \href{https://ctan.org/pkg/lshort}{\textcolor{blue}{lshort}} website.

The beginning of this document shows the structure of the sections, which are uniform in all works: title page, abstract, tiivistelmä, acknowledgements, symbols and abbreviations, and table of contents.

When you write your thesis, the introduction explains the reasons for the research and what it aims to achieve. It also gives a brief overview of the methodology used and key results. The first paragraph should answer the following questions: What is your thesis about? Why is this topic important to study right now? Why is it important in general? The first paragraph entices people to read your thesis.

The second paragraph briefly presents the key findings of previous studies, and the third one explains what previous research has not taken into consideration or examined. In other words, it explains why your study is necessary. Conclude your introduction by relating the objectives, research problem, research questions, limitations and thesis structure briefly. 
